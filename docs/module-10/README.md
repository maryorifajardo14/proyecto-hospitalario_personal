# Módulo 10 — Expediente médico electrónico base

Documentación de análisis y diseño del módulo de Expediente médico electrónico base del Sistema Hospitalario Integrado (ASII 2026).
...
Entrega vertical funcional del módulo (código, migraciones PostgreSQL, pruebas, ADR y evidencia), evaluada de
forma independiente del plan semanal de arriba: ver [`docs/modulos/mod10/`](../modulos/mod10/), empezando por
[`ESPECIFICACION.md`](../modulos/mod10/ESPECIFICACION.md) y [`ADR-001-arquitectura.md`](../modulos/mod10/ADR-001-arquitectura.md).

## Estado de entregas semanales
